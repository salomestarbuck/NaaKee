          ...
          <div class="wdwt_ctrl_btn_container">
            ...
            if ($enable_image_fullscreen) {
              if (!$open_with_fullscreen) {
                ?>
                <i title="<?php esc_attr_e('Maximize', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_resize-full fa fa-expand "></i>
                <?php
              }
              ?>
              <i title="<?php echo esc_attr_e('Fullscreen', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_fullscreen fa fa-arrows-alt"></i>
            <?php }
