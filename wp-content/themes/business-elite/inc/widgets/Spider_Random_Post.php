...
class Business_elite_random_post extends WP_Widget {

	// Constructor //

	function __construct() {
		$widget_ops = array( 'classname' => WDWT_VAR.'_random_post', 'description' => __( 'Spider Random Post allows you to show posts in a random order in a sidebar.', "business-elite" ) ); // Widget Settings
		$control_ops = array( 'id_base' => WDWT_VAR.'_random_post' ); // Widget Control Settings
		parent::__construct( WDWT_VAR.'_random_post', __( 'Spider Random Post', "business-elite" ), $widget_ops, $control_ops ); // Create the widget
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __('Title:',"business-elite"); ?></label>
		...
		<table width="100%" class="paramlist admintable" cellspacing="1">
			...
			<tr>
				<td style="width:120px" class="paramlist_key"><span class="editlinktip"><label style="font-size:10px" id="paramsstandcatid-lbl" for="Category" class="hasTip"><?php echo __('Select Category',"business-elite"); ?></label></span></td>
				<td class="paramlist_value">
					<select name="<?php echo $this->get_field_name('Category'); ?>" id="<?php echo $this->get_field_id('category') ?>" style="font-size:10px" class="inputbox">
						<option value="0"><?php echo __('Select Category',"business-elite"); ?></option>
			...
			<tr>
			<tr><td><br /></td></tr>
			<td style="width:120px" class="paramlist_key"><span class="editlinktip"><label style="font-size:10px" id="paramsrand_show-lbl" for="quantity_of_posts"><?php echo __('Quantity of Posts:',"business-elite"); ?></label></span></td>
			...
			<tr><td><br /></td></tr>
			<tr>
				<td style="width:120px" class="paramlist_key"><span class="editlinktip"><label style="font-size:10px"  for="autoupdate"><?php echo __('Auto Update',"business-elite"); ?></label></span></td>
				<td class="paramlist_value"><span id="cuca"></span>
					<input type="radio" name="<?php echo $this->get_field_name('AutoUpdate'); ?>" value="0" <?php checked($instance['AutoUpdate'],0); ?>  onchange="document.getElementById('<?php echo $this->get_field_id('Updating_Time') ?>time_sec').setAttribute('style','display:none')" id="showup0"><?php echo __(' No',"business-elite"); ?>
					<input type="radio" name="<?php echo $this->get_field_name('AutoUpdate'); ?>" value="1" <?php checked($instance['AutoUpdate'],1); ?> onchange="document.getElementById('<?php echo $this->get_field_id('Updating_Time') ?>time_sec').removeAttribute('style');" id="showup1"> <?php echo __('Yes',"business-elite"); ?>

				</td>
			</tr>
			<tr><td><br /></td></tr>
			<tr>
				<td width="120px" class="paramlist_key"><span class="editlinktip"><label style="font-size:10px" id="paramsstyle-lbl" for="Style_sra"><?php echo __('Visualization',"business-elite"); ?></label></span></td>
				<td class="paramlist_value">
					<select name="<?php echo $this->get_field_name('Style_sra'); ?>" id="<?php echo $this->get_field_id('Style_sra') ?>" class="inputbox">
						<option value="1" <?php selected($instance['Style_sra'],1); ?>><?php echo __('Style 1',"business-elite"); ?></option>
						<option value="2" <?php selected($instance['Style_sra'],2); ?>><?php echo __('Style 2',"business-elite"); ?></option>
						<option value="3" <?php selected($instance['Style_sra'],3); ?>><?php echo __('Style 3',"business-elite"); ?></option>
						<option value="4" <?php selected($instance['Style_sra'],4); ?>><?php echo __('Style 4',"business-elite"); ?></option>
						<option value="5" <?php selected($instance['Style_sra'],5); ?>><?php echo __('Random',"business-elite"); ?></option>
					</select></td>
			</tr>
			<tr><td><br /></td></tr>
			<tr id="<?php echo $this->get_field_id('Updating_Time') ?>time_sec"	<?php if(!$instance['AutoUpdate']==1) echo   'style="display:none"'; ?>>
				<td style="width:120px" class="paramlist_key"><span class="editlinktip"><label style="font-size:10px" for="Updating_Time"><?php echo __('Time of update(sec)',"business-elite"); ?></label></span></td>
				<td class="paramlist_value">
...
add_action('widgets_init', create_function('', 'return register_widget("Business_elite_random_post");'));
...
function Business_elite_random_post_fornt_end(){
