...
class WDWT_homepage_page_class
{
  ...
  function __construct()
  {
    ...
    add_filter("wdwt_admin_setting_output_opt_top_posts_categories", array("WDWT_homepage_page_class","add_woo_categories"));
    add_filter("wdwt_admin_setting_output_opt_category_tabs_categories", array("WDWT_homepage_page_class","add_woo_categories"));
    add_filter("wdwt_admin_setting_output_opt_content_posts_categories", array("WDWT_homepage_page_class","add_woo_categories"));
    add_filter("wdwt_admin_setting_output_opt_portfolio_categories", array("WDWT_homepage_page_class","add_woo_categories"));

    add_filter("wdwt_admin_setting_output_opt_featured_posts", array("WDWT_homepage_page_class","add_woo_posts"));
    ...
    $this->options = array(
      ...
      "top_posts_orderby" => array(
        "name" => "top_posts_orderby",
        "title" => "",
        'type' => 'select',
        "sanitize_type" => "sanitize_text_field",
        "valid_options" => array('date'=>__("Date", "business-elite"), 'name'=>__("Slug", "business-elite"),'title'=>__("Title", "business-elite")),
        "description" => __("Order by", "business-elite"),
        'section' => 'homepage_top_posts',
        'tab' => 'homepage',
        'default' => array('date'),
        'customizer'=>array()
      ),
      "top_posts_order" => array(
        "name" => "top_posts_order",
        "title" => "",
        'type' => 'select',
        "sanitize_type" => "sanitize_text_field",
        "valid_options" => array('asc'=>__("Ascending", "business-elite"), 'desc'=>__("Descending", "business-elite")),
        "description" => __("Order of posts", "business-elite"),
        'section' => 'homepage_top_posts',
        'tab' => 'homepage',
        'default' => array('desc'),
        'customizer'=>array()
      ...
      "top_posts_categories" => array(
        ...
        "description" => __("Filter posts only from these categories.", "business-elite"),
        'section' => 'homepage_top_posts',
        'tab' => 'homepage',
        'default' => array(''),
        'customizer' => array()
      ...
      "top_post_effect" => array(
        ...
        "description" => __("Select the effect. All effects are available in pro version.", "business-elite"),
        'section' => 'homepage_top_posts',
        'tab' => 'homepage',
        'default' => array('none'),
        'customizer' => array()
      ...
      "category_tabs_categories" => array(
        ...
        "sanitize_type" => "sanitize_text_field",
        "valid_options" => $this->get_categories(),
        "description" => __("Show posts from these categories.", "business-elite"),
        'section' => 'homepage_tabs',
        'tab' => 'homepage',
        'default' => $this->get_categories_ids(), // not filter, but show only these
        'customizer' => array()
      ),
      /*------ FEATURED POST ------*/
      ...
      'content_posts_enable' => array(
        ...
        'show' => array(
          ...
          'content_posts_margin',
          'content_posts_orderby',
          'content_posts_order',
        ),
        'hide' => array(),
      ...
      "content_posts_orderby" => array(
        "name" => "content_posts_orderby",
        "title" => "",
        'type' => 'select',
        "sanitize_type" => "sanitize_text_field",
        "valid_options" => array('date'=>__("Date", "business-elite"), 'name'=>__("Slug", "business-elite"),'title'=>__("Title", "business-elite")),
      ...
      "content_posts_order" => array(
        "name" => "content_posts_order",
        "title" => "",
        'type' => 'select',
        "sanitize_type" => "sanitize_text_field",
        "valid_options" => array('asc'=>__("Ascending", "business-elite"), 'desc'=>__("Descending", "business-elite")),
      ...
      'content_posts_margin' => array(
        "name" => "content_posts_margin",
        "title" => __("Content Posts Margin", "business-elite"),
        'type' => 'number',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Margin of content posts blocks", "business-elite"),
        'section' => 'homepage_content_posts',
        'tab' => 'homepage',
        'default' => '0',
        'min' => '0',
      ...
      'contact_us_enable' => array(
        ...
        'type' => 'checkbox_open',
        "description" => __("Check the box to display contact information and social links.", "business-elite"),
        'show' => array(
          'contact_us_bg',
          'contact_us_title',
      ...
      'contact_us_address' => array(
        ...
        'type' => 'text',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Here you can write your Address", "business-elite"),
        'section' => 'homepage_contact',
        'tab' => 'homepage',
      ...
      'linkedin_enable' => array(
        ...
        "title" => __("Linkedin Icon", "business-elite"),
        'type' => 'checkbox_open',
        "description" => __("Check the box to display Linkedin icon.", "business-elite"),
      ...
      'linkedin_url' => array(
        "name" => "linkedin_url",
        "title" => __("Linkedin URL", "business-elite"),
        'type' => 'text',
        "sanitize_type" => "esc_url_raw",
        "description" => __("Enter your Linkedin Profile URL below.", "business-elite"),
        'section' => 'homepage_links',
        'tab' => 'homepage',
        'default' => '',
        'customizer' => array()
